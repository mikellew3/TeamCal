...
async function sendSignupEmail({ name, email }) {
  ...
  const html = `<!doctype html><html><body style="margin:0;padding:0;background:#e8e6e1;font-family:Inter,sans-serif;">
    ...
    <tr><td style="padding:28px 32px;">
      <div style="font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#1f6b6b;font-weight:600;margin-bottom:6px;">MG Surgical Associates · New Signup</div>
